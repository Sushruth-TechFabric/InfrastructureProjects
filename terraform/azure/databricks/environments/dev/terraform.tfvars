...
subscription_id = "17a74f4d-a8f5-4955-9e38-9d222b8ea023"
...
# Left UNSET on purpose (E3): hub_resource_group_name derives from this root's
# own project/region_abbrev/instance via the naming convention
# (rg-networking-dbx-shared-wus3-001) — the same hub staging uses. Override
# only if this spoke's hub was deployed with different tokens.
...
# Left UNSET on purpose (E3): derives to "stdbxdevwus3001". Override only if
# that name is already taken globally.
